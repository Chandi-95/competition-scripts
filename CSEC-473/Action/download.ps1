...
(New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/Chandi-95/competition-scripts/main/CSEC-473/Action/5minplan.bat", "$HOME\Music\5min.bat")
