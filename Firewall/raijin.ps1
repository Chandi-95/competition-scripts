...
# DNS
netsh advfirewall firewall add rule name="DNS" action=allow protocol=udp localport=53 remoteport=53 dir=out 
netsh advfirewall firewall add rule name="DNS" action=allow protocol=udp localport=53 remoteport=53 dir=in 
